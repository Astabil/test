...
CHESSBOARD_SIZE = (9,6)
img_dir_left = "/home/minneyar/Desktop/stereocam2/dir_left"
img_dir_right = "/home/minneyar/Desktop/stereocam2/dir_right"
...
def calibrate(objpoints, imgpoints, img_size, gray):
    ...
    print("rvecs", rvecs)
    rms, _, _, _, _ = cv2.fisheye.calibrate(objpoints,imgpoints,
                                            gray.shape[::-1],K,D,
